---
title: 'GSE22544 Series: Bootstrapping Technique'
...
Read data frame that contains exprs data:
```{r, eval=FALSE}
...
for (i in sum_vect){ 
  sum_sig <- as.numeric(x>180) # as.numeric function converts boolean output to 0s and 1s
...
Output of Confusion Matrix and assigning the table result to a new variable:
```{r, eval=FALSE}
